            ...
            <div class="bg-white/10 backdrop-blur-md rounded-2xl shadow-2xl border border-white/20 p-8">
                ...
                <form method="POST" action="{{ route('password.store') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <x-text-input id="email" class="block mt-2 w-full bg-white/10 border-white/20 text-white placeholder-purple-200 dark:placeholder-gray-400 focus:border-purple-400 focus:ring-purple-400 rounded-xl" type="email" name="email" :value="old('email', $request->email)" required autofocus autocomplete="username" placeholder="Enter your email address" />
                        <x-input-error :messages="$errors->get('email')" class="mt-2" />
                    </div>

                    <!-- Password -->
                    <div>
                        <x-input-label for="password" value="New Password" class="text-purple-200 dark:text-gray-300" />
                        <x-text-input id="password" class="block mt-2 w-full bg-white/10 border-white/20 text-white placeholder-purple-200 dark:placeholder-gray-400 focus:border-purple-400 focus:ring-purple-400 rounded-xl" type="password" name="password" required autocomplete="new-password" placeholder="Enter your new password" />
                        <x-input-error :messages="$errors->get('password')" class="mt-2" />
                    </div>

                    <!-- Confirm Password -->
                    <div>
                        <x-input-label for="password_confirmation" value="Confirm Password" class="text-purple-200 dark:text-gray-300" />
                        <x-text-input id="password_confirmation" class="block mt-2 w-full bg-white/10 border-white/20 text-white placeholder-purple-200 dark:placeholder-gray-400 focus:border-purple-400 focus:ring-purple-400 rounded-xl" type="password" name="password_confirmation" required autocomplete="new-password" placeholder="Confirm your new password" />
